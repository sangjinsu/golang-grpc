...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x73, 0x75, 0x6c, 0x74, 0x32, 0xb0, 0x03, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61,
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	1, // 6: calculator.CalculatorService.Sum:output_type -> calculator.Response
	1, // 7: calculator.CalculatorService.Minus:output_type -> calculator.Response
	1, // 8: calculator.CalculatorService.Multiply:output_type -> calculator.Response
	1, // 9: calculator.CalculatorService.Divide:output_type -> calculator.Response
	3, // 10: calculator.CalculatorService.PrimeNumberDecomposition:output_type -> calculator.PrimeNumberDecompositionResponse
	5, // 11: calculator.CalculatorService.Average:output_type -> calculator.AverageResponse
